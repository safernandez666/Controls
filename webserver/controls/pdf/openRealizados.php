...
$fpdf = new pdf();
$fpdf->SetTitle('Controles Realizados');
$fpdf->AddPage('portrait', 'A4');
...
$fpdf->SetX(20);
$fpdf->Cell(70, 10, 'Control', 0, 0, 'C', 1);
$fpdf->Cell(30, 10, 'Responsable', 0, 0, 'C', 1);
$fpdf->Cell(20, 10, 'Usuario', 0, 0, 'C', 1);
$fpdf->Cell(20, 10, 'Controlado', 0, 0, '', 1);
$fpdf->Cell(20, 10, 'Mes', 0, 0, 'C', 1);
...
foreach ($controlesConFecha as $control) {
	...
	if ($control->responsable == 1)
		...
		$resp = 'FISO';
	$fpdf->Cell(30, 10, $resp, 0, 0, 'C', 1);
	$fpdf->Cell(20, 10, $control->usuario, 0, 0, '', 1);
	$fpdf->Cell(20, 10, $control->modificacion, 0, 0, '', 1);
	$mes = $control->mes;
	switch ($mes) {
